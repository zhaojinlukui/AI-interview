...
class QwenTtsServiceTest {
    ...
    void setUp() {
        ...
        ttsService = new QwenTtsService(properties, new AiProperties(), settingsResolver);
    }
    ...
    @Test
    @DisplayName("Should inherit API key from main model when TTS override is empty")
    void testInheritApiKeyFromMainModel() throws Exception {
        VoiceInterviewProperties properties = new VoiceInterviewProperties();
        properties.getQwen().getTts().setApiKey(null);
        AiProperties aiProperties = new AiProperties();
        aiProperties.getModel().setApiKey("main-model-key");

        QwenTtsService service = new QwenTtsService(properties, aiProperties, settingsResolver);
