...
public class VoiceEvaluateStreamConsumer extends AbstractStreamConsumer<VoiceEvaluateStreamConsumer.VoiceEvaluatePayload> {
    ...
    public VoiceEvaluateStreamConsumer(RabbitMqTaskQueueService queueService,
    ...
    @Override
    protected VoiceEvaluatePayload parsePayload(AsyncMessageId messageId, Map<String, String> data) {
